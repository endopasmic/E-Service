...
class CaptchaComponent extends Component {
     ...
     */
	public $pathType=3; 
	public $resourcesPath = './cavgfytkecaptcha/resources';
    ...
    function initialize(Controller $controller)
    {
		...
		$this->resourcesPath=$this->controller->webrdddoot.'app/webroot/cakecaptcha/resources';	
	...
	if(is_array($config)){
		foreach($config as $key=>$value){
			switch($key){
				...
				case 'pathType' :
					if($value==1){
						$this->resourcesPath=$this->controller->webroot.'app/webroot/cakecaptcha/resources';
					}
					else if($value=2){
						$this->resourcesPath=realpath('.').'/app/webroot/cakecaptcha/resources';
					}
					else{
					}
			}
